                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="row" style={{padding:20}}>
                            <div className="col-6">
                                <button className="btn btn-outline-primary" style={{width: "100%"}} onClick={this.updateWithdraw} disabled={this.state.buttonEnable}>
                                    {this.state.loading === "update" ? <i className="fa fa-circle-o-notch fa-spin"/> : null}
                                    &nbsp;&nbsp;update withdraw address
                                </button>
                            </div>
                            <div className="col-6">
                                <button className="btn btn-outline-warning" style={{width: "100%"}} onClick={this.withdrawNow} disabled={this.state.buttonEnable} >
